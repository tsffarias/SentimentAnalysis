...
# database of phrases(700) and their probable emotions(6) = alegria, desgosto, medo, raiva, surpresa, tristeza.
...
stopwordsnltk.remove('não')
stopwordsnltk.append('vou')
stopwordsnltk.append('tão')
# show all NLTK stopwords
# print(stopwordsnltk)

# applying the stemming technique as well as removing the stop words
def aplicaStemmer(texto):
    # RSLPStemmer is used for portuguese language
...
# caracteristicasFrase = extratorPalavras(['trabalh', 'agrad', 'gost'])
# print(caracteristicasFrase)

# database pre-processed
...
# this shows some interesting database information
# print(classificador.show_most_informative_features(5))


fraseTeste = input('Digite uma frase: ')
fraseTesteStemming = []
stemmer = nltk.stem.RSLPStemmer()
for (palavrasTreinamento) in fraseTeste.split():
    comStem = [p for p in palavrasTreinamento.split()]
    fraseTesteStemming.append(str(stemmer.stem(comStem[0])))

# print(fraseTesteStemming)

novo = extratorPalavras(fraseTesteStemming)
# print(novo)
